...
- [x] **CANVA-01**: User can select the appropriate Canva template set for the current tour type
- [x] **CANVA-02**: System maps reviewed content into 2 separate Canva templates per tour: Itinerary and Menu
- [x] **CANVA-03**: System creates editable Canva outputs rather than static-only assets
