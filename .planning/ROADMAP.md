...
- [x] 02-05: Quality scoring, extraction pipeline, and route integration (Wave 3)
- [x] 02-06: Extraction result UI and core unit tests (Wave 4)
- [x] 02-07: Quality scoring tests, e2e tests, and phase gate (Wave 5)
...
- [x] 04-02: Implement Canva async generation, polling, and token lifecycle handling.
- [x] 04-03: Ship the reviewed-content-to-editable-link flow end to end.
...
- [x] 05-02: Add admin management for template mappings and maintainable company rules.
